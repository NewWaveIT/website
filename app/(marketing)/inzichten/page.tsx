  ...
  return (
    <div className="p-inzichten">
      <PaginaHero
        ...
        titel="Kennis die je "
        accent="morgen"
        staart=" kunt gebruiken."
        lead="Sectorkennis die je vooruit denkt. Praktijkervaring uit projecten bij gemeenten, banken, zorginstellingen en mobiliteitsbedrijven, vertaald naar artikelen die je direct kan gebruiken, geen gerecycled nieuws."
