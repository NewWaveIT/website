...
export const DIENSTEN: Record<string, DienstDetail> = {
  mendix: {
    ...
    insights: [
      {
        cat: "Mendix",
        meta: "5 min · 15 mei 2026",
        titel: "Wanneer low-code wél en niet de juiste keuze is",
      },
      {
        cat: "Mendix",
        meta: "6 min · 28 apr 2026",
        titel: "Legacy vervangen zonder de winkel te sluiten",
      },
  ...
  strategie: {
    ...
    insights: [
      {
        cat: "Strategie",
        meta: "5 min · 14 mei 2026",
        titel: "Waarom digitale strategieën stranden in de la",
      },
      {
        cat: "Strategie",
        meta: "6 min · 27 apr 2026",
        titel: "Prioriteren: de kunst van het niet doen",
      },
      {
        cat: "Strategie",
        meta: "4 min · 6 apr 2026",
        titel: "Business en IT: één taal in acht weken",
      },
    ],
