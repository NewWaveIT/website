...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    prijsToelichting:
      "Afhankelijk van het aantal koppelingen. Vaste prijs na de architectuurintake.",
    boekPunten: [
    ...
    meeneemt: [
      {
        ...
        tekst:
          "Eén keer gebouwd naar je kernsystemen, daarna aanroepen in plaats van opnieuw maken.",
      },
      {
        icon: "lock",
