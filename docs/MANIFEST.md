...
| ------------------- | ------ | ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| algemeen            | 18     | /                   | `app/(marketing)/inzichten/[slug]/page.tsx`<br>`app/(marketing)/inzichten/page.tsx`<br>`app/(marketing)/page.tsx`<br>`components/layout/schil-cms.tsx`                                                                                                                                                                                                            |
| contact             | 66     | /contact            | `app/(marketing)/contact/page.tsx`<br>`lib/contact-data.ts`                                                                                                                                                                                                                                                                                                       |
...
| inzichten           | 11     | /inzichten          | `app/(marketing)/inzichten/[slug]/page.tsx`<br>`app/(marketing)/inzichten/page.tsx`                                                                                                                                                                                                                                                                               |
...
| vacature-detail     | 36     | /werken-bij         | `app/(marketing)/vacatures/[slug]/page.tsx`<br>`app/(marketing)/werken-bij/page.tsx`                                                                                                                                                                                                                                                                              |
| werken-bij          | 42     | /werken-bij         | `app/(marketing)/werken-bij/page.tsx`                                                                                                                                                                                                                                                                                                                             |
...
- bronbestanden: 196
- clientComponenten: 38
- servercomponenten: 158
- unittests: 30
- e2etests: 5
